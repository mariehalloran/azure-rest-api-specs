...
This is the AutoRest configuration file for storage context cache.

## Getting Started

To build the SDKs for storage context cache, simply install AutoRest via `npm` (`npm install -g autorest`) and then run:
...
These are the global settings for the storage context cache.
...
input-file:
  - preview/2026-03-01-preview/StorageContextCacheRP.json
```
...
input-file:
  - preview/2026-02-01-preview/StorageContextCacheRP.json
```
...
input-file:
  - preview/2026-01-01-preview/StorageContextCacheRP.json
```
