...
input-file:
  - Microsoft.HybridConnectivity/preview/2026-04-01-preview/hybridconnectivity.json
```
...
input-file:
  - Microsoft.HybridConnectivity/preview/2026-09-01-preview/hybridconnectivity.json
suppressions:
  - code: GuidUsage
    from: hybridconnectivity.json
    where: $.definitions["Azure.Core.uuid"].format
    reason: >-
      Used only for PublicCloudConnectorProperties.subscriptionPool and
      PublicCloudConnectorPropertiesUpdate.subscriptionPool (subscription IDs,
      RFC 4122 UUIDs).
```
