...
tag: package-2026-05-07-preview
```
### Tag: package-2026-05-07-preview
These settings apply only when `--tag=package-2026-05-07-preview` is specified on the command line.
```yaml $(tag) == 'package-2026-05-07-preview'
input-file:
  - preview/2026-05-07-preview/MongoWorkloadsDiscovery.json
```
