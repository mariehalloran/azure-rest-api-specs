...
These settings apply only when `--tag=package-2026-04-22-preview` is specified on the command line.

```yaml $(tag) == 'package-2026-04-22-preview'
input-file:
  - Microsoft.Titan/preview/2026-04-22-preview/titan.json
```
