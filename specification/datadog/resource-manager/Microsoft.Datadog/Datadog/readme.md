...
input-file:
  - preview/2025-12-26-preview/swagger.json
```
...
input-file:
  - preview/2025-11-03-preview/swagger.json
```
...
input-file:
  - stable/2025-06-11/swagger.json
```
...
input-file:
  - stable/2025-01-07/swagger.json
```
...
input-file:
  - stable/2024-03-01/swagger.json
```
...
input-file:
  - stable/2023-10-20/swagger.json
```
...
input-file:
  - stable/2023-07-07/swagger.json
```
...
input-file:
  - stable/2021-03-01/swagger.json
```
...
input-file:
  - preview/2020-02-01-preview/swagger.json
```
...
input-file:
  - stable/2022-06-01/swagger.json
```
...
input-file:
  - stable/2023-01-01/swagger.json
```
